...
- Package metadata updated to 2.1.2 for the runtime and design-time packages.
- Public release ZIP/tag label is `2.1.2` through the `-ReleaseVersion` workflow.
...
- Public ZIP created as `LazRibbon_2.1.2_source_20260701_092650.zip` with SHA256 `351D388C2A6B2DA569893262EDC5307E35442304FA7FAEB3EC4F999972B1EA38`.
...
- Public release ZIP/tag label is `2.1.0` through the `-ReleaseVersion` workflow.
- The final release preflight validates the full build matrix, clean checkout install path and release ZIP hygiene before publishing.
- Public ZIP created as `LazRibbon_2.1.0_source_20260629_172528.zip` with SHA256 `4D5F82C7DC7DF232B57A4BC786A132EFFEE68F56C657E965CE6BA4C986BD9AAC`.

## 2.0.0 check

- Package metadata remains 2.0.0 for the runtime and design-time packages.
- Public release ZIP/tag label is `2.0.0` through the `-ReleaseVersion` workflow.
- The final release preflight validates the full build matrix, clean checkout install path and release ZIP hygiene before publishing.
- Public ZIP created as `LazRibbon_2.0.0_source_20260625_111943.zip` with SHA256 `F55A20F322FFE3F78BC023112FF877E8BC2A68E540F82BE24859C3EE9CD48B24`.
