...
Post-2.0 development has started on the 2.1 line. The next roadmap is in `docs/release/ROADMAP_2_1.md`, and the first quality checkpoint is `docs/quality/SKIN_EDITOR_APPEARANCE_COVERAGE_2_1.md`, generated by `tools/export_skin_editor_2_1_coverage.ps1`. The intent is to improve the standalone Skin Editor workflow while keeping the 2.0 public API stable.
