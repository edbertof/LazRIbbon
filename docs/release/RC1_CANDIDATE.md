...
Historical note: this document describes the old pre-1.0 RC path. The current 2.0 release-candidate workflow is documented in `docs/release/RELEASE_CANDIDATE_PREP.md` and `docs/release/RELEASE_2_0_0.md`.
