...
Add-Gate '2.0 RC2 release notes draft exists' ($(if (Test-SourcePath 'docs/release/RELEASE_2_0_0_RC2.md') { 'Ready' } else { 'Review' })) 'Release-candidate notes are staged for the current 2.0 RC.'
