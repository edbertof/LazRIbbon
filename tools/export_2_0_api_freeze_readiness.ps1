...
Add-Gate '2.0 RC3 release notes draft exists' ($(if (Test-SourcePath 'docs/release/RELEASE_2_0_0_RC3.md') { 'Ready' } else { 'Review' })) 'Release-candidate notes are staged for the current 2.0 RC.'
...
$out.Add('This is a compact release-facing view of the API freeze path; the lower-level source of truth remains the individual audits and the release-candidate preflight.')
$out.Add('')
