...
- Release notes for `2.0.0-rc2` are present in
...
- Keep `docs/release/RELEASE_2_0_0_RC2.md` current as the public release notes
  for the current RC.

### 4. Release Candidate

- Publish `2.0.0-rc2` from the documentation and API-freeze pass.
